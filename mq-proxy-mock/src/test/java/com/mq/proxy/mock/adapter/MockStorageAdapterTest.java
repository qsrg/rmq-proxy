...
public class MockStorageAdapterTest {
    ...
    public void testPullMessage() throws Exception {
        ...
        PullResult result = adapter.pullMessage("TestGroup", "TestTopic", 1, 0, 10, 0, 0L, 3000, null, null, 0L, BROKER_ADDR);
    ...
    public void testPullMessageNotFound() throws Exception {
        PullResult result = adapter.pullMessage("TestGroup", "NonExistTopic", 0, 0, 10, 0, 0L, 3000, null, null, 0L, BROKER_ADDR);
